      ...
      <main className="flex-grow flex flex-col items-center py-20 px-6 relative z-10">
        <div className="max-w-5xl w-full">
          <motion.div initial="hidden" animate="visible" variants={fadeIn} className="flex items-center gap-4 mb-8 border-b border-[#1d231d] pb-6">
             ...
             <div>
               <span className="text-xs font-mono font-bold text-blue-400 block mb-1">Section 2: G.A.D. (The Grand Architect Divine)</span>
               <h1 className="text-4xl md:text-5xl font-semibold text-[#f2efe6] tracking-tight leading-none">The Admin Password</h1>
             </div>
          </motion.div>
          ...
          <motion.div initial="hidden" animate="visible" variants={fadeIn} transition={{ delay: 0.3 }} className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-12">
            ...
            <div className="relative rounded-[2rem] overflow-hidden border border-blue-500/30 shadow-[0_20px_50px_rgba(59,130,246,0.2)] bg-[#141814] aspect-[4/5] group order-2 lg:order-1">
              <Image src="/grand_architect_divine.png" alt="Grand Architect Divine" width={800} height={600} className="w-full h-full object-cover opacity-90 transform transition-transform duration-700" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent pointer-events-none"></div>
              <div className="absolute bottom-8 left-8 right-8">
                <h3 className="text-[#f2efe6] font-semibold text-3xl leading-none">Admin<br/>Override</h3>
            ...
            <div className="flex flex-col gap-6 order-1 lg:order-2">
              <div className="bg-[#141814] p-8 rounded-[2rem] border border-[#1d231d] shadow-xl hover:border-blue-500/30 transition-colors">
                <h3 className="text-xl font-semibold text-[#f2efe6] mb-3 flex items-center gap-3"><span className="w-2.5 h-2.5 rounded-full bg-blue-500"></span> Why we call it G.A.D.</h3>
                <p className="text-[#b8b4a6] text-base leading-relaxed">The traditional AA program asks us to turn our will over to "God as we understood Him" (Step 3). But for many logical, tech-minded people or those with religious baggage, the word "God" triggers the Ego to put its defenses up. By viewing God as the Grand Architect Divine (G.A.D.), it makes the spiritual solution undeniable: You didn't write the original code for your biology or the universe, which means you aren't the Master Programmer. You cannot debug a virus using the same infected brain that caught it. You must hand the Admin Password back to the Architect.</p>
              </div>
              <div className="bg-[#141814] p-8 rounded-[2rem] border border-[#1d231d] shadow-xl hover:border-blue-500/30 transition-colors">
                <h3 className="text-xl font-semibold text-[#f2efe6] mb-3 flex items-center gap-3"><span className="w-2.5 h-2.5 rounded-full bg-blue-500"></span> Where it lives</h3>
                <p className="text-[#b8b4a6] text-base leading-relaxed font-mono text-blue-400">In your daily surrender (Step 3) and quiet meditation (Step 11).</p>
              </div>
              <div className="bg-[#141814] p-8 rounded-[2rem] border border-[#1d231d] shadow-xl hover:border-blue-500/30 transition-colors">
                <h3 className="text-xl font-semibold text-[#f2efe6] mb-3 flex items-center gap-3"><span className="w-2.5 h-2.5 rounded-full bg-blue-500"></span> When to use it</h3>
                <p className="text-[#b8b4a6] text-base leading-relaxed">First thing in the morning before the AIV boots up, and the exact moment you feel your willpower failing.</p>
              </div>
              <div className="bg-[#141814] p-8 rounded-[2rem] border border-[#1d231d] shadow-xl hover:border-blue-500/30 transition-colors">
                <h3 className="text-xl font-semibold text-[#f2efe6] mb-3 flex items-center gap-3"><span className="w-2.5 h-2.5 rounded-full bg-blue-500"></span> How it works</h3>
                <p className="text-[#b8b4a6] text-base leading-relaxed">You stop trying to outsmart the glitch. You pause, admit you are out of your depth, and ask the Grand Architect for the next right instruction.</p>
              </div>
            </div>
